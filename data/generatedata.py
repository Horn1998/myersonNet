...
class Generator():
    ...
    def generate_sample(self, str):
        ...
        if distr_type == 'uniform':
            sample_val1 = np.random.rand(num_instances, 2)*3
            sample_val2 = np.random.rand(num_instances, 2)*2 + 2
            sample_val3 = np.random.normal(2, 2, (num_instances, 2))
            sample_val = np.concatenate((sample_val1, sample_val2), axis=1)
            sample_val = np.concatenate((sample_val, sample_val3), axis=1)
            ...
            sample_val = np.random.normal(5, 2, (num_instances, num_agent))
